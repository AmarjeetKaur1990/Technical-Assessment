  ...
  return (
    <Container className="bg-secondary-purple-3 vh-100" fluid>
        <div className='row align-items-center h-100'>
            <div className='col-md-3 offset-md-2 order-sm-1 order-md-0'>
            ...
            <div className='col-md-5 offset-md-1 landing-right-section'>
                <div className='text-md-right text-sm-center order-sm-0'>
